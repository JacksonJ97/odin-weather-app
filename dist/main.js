...
const getDate = (timestamp, timezone) => {
  ...
  // Format date
  const formattedDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__.default)(cityDate, "PPPP");
...
const processData = (data, units) => {
  ...
  const date = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.getDate)(data.dt, data.timezone);
  ...
  if (units === "metric") {
    windSpeed = (0,_helper__WEBPACK_IMPORTED_MODULE_0__.convertToKPH)(data.wind.speed);
  } else if (units === "imperial") {
...
const getWeather = async (city, units) => {
  try {
    ...
    (0,_view__WEBPACK_IMPORTED_MODULE_1__.displayData)(weatherData, units);
  } catch (error) {
    alert(error);
  }
};
...
// Initial load
(0,_weatherData__WEBPACK_IMPORTED_MODULE_0__.default)("Toronto", "metric");

searchForm.addEventListener("submit", (e) => {
  e.preventDefault();
  (0,_weatherData__WEBPACK_IMPORTED_MODULE_0__.default)(city.value, "metric");
  city.blur();
  searchForm.reset();
  imperial = false;
});
...
toggleBtn.addEventListener("click", async () => {
  const city = (0,_helper__WEBPACK_IMPORTED_MODULE_1__.getCity)();
  let units;
  ...
  await (0,_weatherData__WEBPACK_IMPORTED_MODULE_0__.default)(city, units);
});
